...
// ... (mantenha as importações anteriores)
import { PPEItem, PPEMovement } from './types';

export const INITIAL_PPE_ITEMS: PPEItem[] = [
  { id: 'ppe1', name: 'Capacete de Segurança com Aba', category: 'Proteção Cabeça', certificateNumber: '12345', caExpiryDate: '2026-12-31', currentStock: 15, minStock: 5, manufacturer: 'MSA' },
  { id: 'ppe2', name: 'Bota de Segurança Bracol', category: 'Proteção Pés', certificateNumber: '45678', caExpiryDate: '2025-06-30', size: '42', currentStock: 4, minStock: 6, manufacturer: 'Bracol' },
  { id: 'ppe3', name: 'Luva de Vaqueta G', category: 'Proteção Mãos', certificateNumber: '99887', caExpiryDate: '2024-11-20', currentStock: 25, minStock: 10, manufacturer: 'Danny' },
];

export const ICONS = {
  // ... (ícones anteriores permanecem inalterados)
  PPE: () => (
  ...
  Tyre: () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="4"/><path d="M12 3v2"/><path d="M12 19v2"/><path d="M3 12h2"/><path d="M19 12h2"/></svg>
  ),
  Odometer: () => (
